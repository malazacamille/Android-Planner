...
public class FragmentPersonalAlphabet extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new TaskAdapter(dbHelper.getAllPersonalAlphabet("\"Personal Errands\"","asc"), getActivity(), mRecyclerView);
