...
public class FragmentCalenEvent extends Fragment {
    private RecyclerView mRecyclerView;
    private RecyclerView.LayoutManager mLayoutManager;
    private EverydayDBHelper dbHelper;
    private EventCalenAdapter adapter;
    private TextView title;
    public FragmentCalenEvent() {
        super();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new EventCalenAdapter(dbHelper.getAllCalenType(CalendarList.getdt()), getActivity(), mRecyclerView);
