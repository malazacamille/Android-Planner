...
public class ActivityFour extends FragmentActivity {
    ViewPager viewpager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1=new Intent(ActivityFour.this,NoteAddActivity.class);
    ...
    private void btnAction(int position) {
        if(position==0){
            ...
            btnAddTask.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent1=new Intent(ActivityFour.this,ReminderAddActivity.class);
                    intent1.putExtra(ReminderAddActivity.EXTRA_CATEGORY, Integer.toString(0));
                    startActivity(intent1);
                }
            });
        ...
        if(position==1){
            ...
            btnAddTask.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent=new Intent(ActivityFour.this,EventAddActivity.class);
                    startActivity(intent);
                }
            });
        }
        ...
        if(position==3){
            ...
            btnAddTask.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent=new Intent(ActivityFour.this,NoteAddActivity.class);
                    startActivity(intent);
                }
            });
        }
