...
public class ActivityThree extends FragmentActivity {
    ViewPager viewpager;
    ...
    private void btnAction(int position) {
        if(position==0){
            ...
            btnAddTask.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent1=new Intent(ActivityThree.this,ReminderAddActivity.class);
        ...
        if(position==1){
            ...
            btnAddTask.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent=new Intent(ActivityThree.this,EventAddActivity.class);
                    startActivity(intent);
                }
            });
        }
        ...
        if(position==3){
            ...
            btnAddTask.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent=new Intent(ActivityThree.this,NoteAddActivity.class);
                    startActivity(intent);
                }
            });
        }
