...
public class FragmentOthersPriority extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new TaskPriorityAdapter(dbHelper.getAllPersonalPriority("\"Others\"","asc"), getActivity(), mRecyclerView);
