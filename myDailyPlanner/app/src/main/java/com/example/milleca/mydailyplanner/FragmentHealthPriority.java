...
public class FragmentHealthPriority extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new TaskPriorityAdapter(dbHelper.getAllPersonalPriority("\"Health\"","asc"), getActivity(), mRecyclerView);
