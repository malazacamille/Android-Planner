...
public class FragmentSchoolPriority extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new TaskPriorityAdapter(dbHelper.getAllPersonalPriority("\"School\"","asc"), getActivity(), mRecyclerView);
