...
public class ReminderAddActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        selection=Integer.parseInt(getIntent().getStringExtra(EXTRA_CATEGORY));
        ...
        final CustomSpinnerAdapter adapter = new CustomSpinnerAdapter(ReminderAddActivity.this,
        ...
        priority.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(ReminderAddActivity.this);
        ...
        repeat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final ArrayAdapter<String> catAdapter = new ArrayAdapter<>(ReminderAddActivity.this, R.layout.support_simple_spinner_dropdown_item, catList);
                final ArrayAdapter<String> dueAdapter = new ArrayAdapter<>(ReminderAddActivity.this, R.layout.support_simple_spinner_dropdown_item, dueList);
                ...
                dueDate.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        DatePickerDialog datePickerDialog = new DatePickerDialog(ReminderAddActivity.this, new DatePickerDialog.OnDateSetListener() {
    ...
    public void onBackPressed() {
        if (selection == 0) {
            Intent intent = new Intent(ReminderAddActivity.this, ActivityFive.class);
            startActivityForResult(intent, 1);
        }
        if (selection == 1) {
            Intent intent = new Intent(ReminderAddActivity.this, ContentPersonal.class);
            startActivityForResult(intent, 1);
        }
        if (selection == 2) {
            Intent intent = new Intent(ReminderAddActivity.this, ContentWork.class);
            startActivityForResult(intent, 1);
        }
        if (selection == 3) {
            Intent intent = new Intent(ReminderAddActivity.this, ContentHealth.class);
            startActivityForResult(intent, 1);
        }
        if (selection == 4) {
            Intent intent = new Intent(ReminderAddActivity.this, ContentSchool.class);
            startActivityForResult(intent, 1);
        }
        if (selection == 5) {
            Intent intent = new Intent(ReminderAddActivity.this, ContentOthers.class);
            startActivityForResult(intent, 1);
        }
    }
