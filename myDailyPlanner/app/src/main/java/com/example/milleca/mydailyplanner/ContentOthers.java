...
public class ContentOthers extends AppCompatActivity  {
    OthersTaskAdapter mAdapter;
    ViewPager mPager;
    ImageView back,add;
    Button bt1,bt2,bt3;
    ...
    public void onBackPressed() {
        Intent intent=new Intent(ContentOthers.this,ActivityFive.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new OthersTaskAdapter(getSupportFragmentManager());
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1=new Intent(ContentOthers.this,ReminderAddActivity.class);
                intent1.putExtra(ReminderAddActivity.EXTRA_CATEGORY, Integer.toString(5));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1=new Intent(ContentOthers.this,ActivityFive.class);
                startActivity(intent1);
            }
        });
