...
public class FragmentPersonalPriority extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new TaskPriorityAdapter(dbHelper.getAllPersonalPriority("\"Personal Errands\"","asc"), getActivity(), mRecyclerView);
