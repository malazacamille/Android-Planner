...
public class ContentHealth extends AppCompatActivity  {
    HealthTaskAdapter mAdapter;
    ViewPager mPager;
    ImageView back,add;
    Button bt1,bt2,bt3;
    ...
    public void onBackPressed() {
        Intent intent=new Intent(ContentHealth.this,ActivityFive.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new HealthTaskAdapter(getSupportFragmentManager());
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1=new Intent(ContentHealth.this,ReminderAddActivity.class);
                intent1.putExtra(ReminderAddActivity.EXTRA_CATEGORY, Integer.toString(3));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1=new Intent(ContentHealth.this,ActivityFive.class);
                startActivity(intent1);
            }
        });
