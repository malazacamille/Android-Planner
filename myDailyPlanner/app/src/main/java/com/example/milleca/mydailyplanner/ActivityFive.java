...
public class ActivityFive extends FragmentActivity {
    ViewPager viewpager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAddTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1=new Intent(ActivityFive.this,ReminderAddActivity.class);
    ...
    private void btnAction(int position) {
        ...
        if(position==1){
            ...
            btnAddTask.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent=new Intent(ActivityFive.this,EventAddActivity.class);
                    startActivity(intent);
                }
            });
        }
        ...
        if(position==3){
            ...
            btnAddTask.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent=new Intent(ActivityFive.this,NoteAddActivity.class);
                    startActivity(intent);
                }
            });
        }
