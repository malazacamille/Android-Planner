...
public class ContentWork extends AppCompatActivity  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText("Work");
        mAdapter = new WorkTaskAdapter(getSupportFragmentManager());
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1=new Intent(ContentWork.this,ReminderAddActivity.class);
                intent1.putExtra(ReminderAddActivity.EXTRA_CATEGORY, Integer.toString(2));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1=new Intent(ContentWork.this,ActivityFive.class);
                startActivity(intent1);
            }
        });
