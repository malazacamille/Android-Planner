...
public class FragmentCalenNote extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new EventCalenAdapter(dbHelper.getAllCalen(CalendarList.getdt(),"note"), getActivity(), mRecyclerView);
